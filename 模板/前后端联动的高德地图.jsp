...
<div class="panel" style="margin:0!important;">
    <div class="panel-heading bg-info" style="height: 50px;">
        ...
        <div class="btn-group pull-right">
            ...
            <%--</button>--%>
            <button type="button" onclick="noUserAllot()" class="btn btn-success btn" title="地图中无人选请继续！" aria-label="Light Align">
...
<script type="text/javascript">
    ...
    var center = [jsAdLongitude, jsAdLatitude] || [117.000923, 36.675807];
                ...
                marker.on("click", function (e) {
                    ...
                    <c:forEach items="${tasks}" var="workTask">
                        if (user.userId == "${workTask.executor}") {
                            if ("${workTask.state}" == "accepted") {
                                accept += ${workTask.taskCount};
                            } else if ("${workTask.state}" == "finished" || "${workTask.state}" == "costed" || "${workTask.state}" == "closed") {
